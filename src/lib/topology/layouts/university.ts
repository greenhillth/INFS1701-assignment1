...
const networkProfiles: Record<string, NodeNetworkProfile> = {
        ...
        'labs-ap': {
                ...
                notes: 'AP tuned for IoT prototyping spaces and mobile labs.'
        },
        'labs-workstations': {
                ipAddress: '10.4.1.120',
                subnet: '10.4.0.0/22',
                macAddress: '58:6D:8F:44:20:78',
                notes: 'Dual-boot workstation assigned to the robotics cohort.'
        },
        'labs-iot': {
                ipAddress: '10.4.1.200',
                subnet: '10.4.0.0/22',
                macAddress: '8C:85:90:12:7A:1C',
                notes: 'Sample MAC from the engineering IoT development kit.'
        }
};
        ...
        nodes: [
                        ...
                        [
                                {
                                        ...
                                        overrides: {
                                                ...
                                                network: networkProfiles['labs-distribution']
                                        }
                                },
                                {
                                        template: 'accessSwitch',
                                        ...
                                        overrides: {
                                                ...
                                                network: networkProfiles['labs-access']
                                        }
                                }
                        ],
                ...
                placeDevice('accessPoint', {
                        ...
                        overrides: {
                                ...
                                network: networkProfiles['labs-ap']
                        },
                        ...
                        [
                                {
                                        ...
                                        overrides: {
                                                ...
                                                network: networkProfiles['labs-workstations']
                                        }
                                },
                                {
                                        template: 'endpointCluster',
                                        ...
                                        overrides: {
                                                ...
                                                network: networkProfiles['labs-iot']
                                        }
                                }
                        ],
